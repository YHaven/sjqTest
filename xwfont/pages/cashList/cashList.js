...
Page({
	...
	onShow:function(){
		...
		plana.getPersonalList.call(that,config.apiList.plana.getCashList,params,function(res){
  ...
  //   });
	...
	onReachBottom: function() {
		...
		if (!that.data.showLoading) {
			...
			plana.getPersonalList.call(that,config.apiList.plana.getCashList,params);
		}
	},
