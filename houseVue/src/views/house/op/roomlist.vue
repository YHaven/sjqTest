...
<div class="container">
  ...
  <div class="content profile fade-transition" distance="55" v-pull-to-refresh="refresh" v-infinite-scroll="loadMore">
    ...
    <div class="card-container" >
      <div class="list-title"><span>采荷新村</span><span class="count">闲置:1 <i class="icon iconfont icon-fold" @click="narExt($event)"></i></span></div>
    ...
    <div class="card-container" >
      <div class="list-title"><span>其他村</span><span class="count">闲置:3 <i class="icon iconfont icon-fold" @click="narExt($event)"></i></span></div>
      <v-card-container v-for="task in tasks | orderBy 'created' 1">
