...
<div class="container">
  ...
  <div class="content profile fade-transition" distance="55" v-pull-to-refresh="refresh" v-infinite-scroll="loadMore">
    ...
    <ul class="bar-col clearfix">
      <li class="bar-item">
        <span class="bar-value">123.45</span>
      ...
      <li class="bar-item">
        <span class="bar-value">123.45</span>
        <span class="bar-label">结余</span>
      </li>
    </ul>
    <ul class="bar-col clearfix" >
      <li class="bar-item active">
        <span class="bar-label">本月</span>
      </li>
      <li class="bar-item" v-link="{path: '/house/op/accountbooksy', replace: true}">
        <span class="bar-label">上月</span>
      </li>
      <li class="bar-item" v-link="{path: '/house/op/accountbookgz', replace: true}">
        <span class="bar-label">更早</span>
      </li>
    </ul>

    <div class="card-container" >
      <div class="list-title"><span>2017-01-24</span></div>
      <v-card-container v-for="task in tasks | orderBy 'created' 1">

        <div class="item-content" v-link="{path: '/house/op/accountdetail?id='+task.id, replace: true}">
          <p class="rental-title">{{task.rentalTime}} 租金</p>
    ...
    <div class="card-container" >
      <div class="list-title"><span>2017-01-25</span></div>
      <v-card-container v-for="task in tasks | orderBy 'created' 1">
