    ...
    <div id="app">
        ...
        <div class="header-area">
            <ul class="wh-nav clearfix swiper-wrapper">
                <li class="active swiper-slide" cat_name=""><a href="javascript:;"><img src="" alt=""><span>杭州站</span></a></li>
                <li cat_name="10" class="swiper-slide"><a href="javascript:;"><img src="" alt=""><span>西安站</span></a></li>
                <li cat_name="2" class="swiper-slide"><a href="javascript:;"><img src="" alt=""><span>银川站</span></a></li>
                <li cat_name="3" class="swiper-slide"><a href="javascript:;"><img src="" alt=""><span>广州站</span></a></li>
                <li cat_name="3" class="swiper-slide"><a href="javascript:;"><img src="" alt=""><span>广州站</span></a></li>
            </ul>
        </div>
...
<script>
    ...
    import Swiper from 'common/js/swiper-3.4.2.jquery.min'
    ...
    mounted () {                     //页面完成加载
        ...
        var timer = setInterval(function(){
            var swiper = new Swiper('.header-area', {
                              slidesPerView: 5,
                              spaceBetween: "2%"
...
<style>
    ...
    .header-area{
    box-sizing: content-box;display: flex;position: relative;transition-property: transform;width: 100%;z-index: 1;}
    #app {
