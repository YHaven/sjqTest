...
<div class="container">
  <div class="content home" distance="55" v-pull-to-refresh="refresh" v-infinite-scroll="loadMore">
    ...
    <bar class="home-bar clearfix">
      ...
      <a class="tab-item active" v-link="{path: '/home/women'}">
...
export default {
  route: {
    data () {
      ...
      return this.$http.get(planPro.ajaxUrl.womenBT+'?start=1')
  ...
  methods: {
    refresh () {
      setTimeout(function () {
        this.pageIndex = 1
      this.$http.get(planPro.ajaxUrl.womenBT+'?start='+this.pageIndex)
      .then(({data: {success, info, data}}) => {
