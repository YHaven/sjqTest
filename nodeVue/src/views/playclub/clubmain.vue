  ...
  <div class="content home" distance="55" v-pull-to-refresh="refresh" v-infinite-scroll="loadMore">
    ...
    <div class="card-container">
      ...
      <ul >
        ...
        <li class="item-content" v-for="task in tasks | orderBy 'created' 1">
          <div class="head-img">
            <img src="{{task.company.imgUrl}}" alt="">
          </div>
          <div class="right">
            <p class="r-name">{{task.company.name}}</p>
            <p class="r-title">此处是文章标题</p>
            ...
            <p class="r-bottom"><span class="b-time">30分钟前</span><span class="b-count"><i class="icon iconfont icon-comment"></i>{{task.company.sellCount}}</span></p>
          </div>
...
.product-list li{position: relative;display: table-cell;width: 1%;height:4rem;border: 1px solid #ddd; }
