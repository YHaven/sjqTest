  ...
  <div id="app">
    ...
    <form class="refund-form" v-if="step == 2">
        ...
        <ul class="goods-list">
            <li class="goods-item clearfix" v-for="goods in goods_list">
              ...
              <div class="goods-opra">
                <span class="refund-number"><i class="minus">-</i><em minnum="0" :maxnum="goods.goods_number" :rec_id="goods.rec_id">{{goods.goods_number}}</em><i class="plus">+</i></span>
      ...
      <p v-if="refund_type != 2">
        ...
        <span>
          <input name="refund_money" type="number" :placeholder="'最多可申请金额:'+maxmoneyprice" :maxprice="maxmoneyprice">
        </span>
      </p>
      <p v-if="refund_type != 2">
    ...
    methods: {                          //方法
      ...
      submitForm(){
        ...
        $('.goods-list').find('.goods-item').each(function(){
          ...
          rec_info_arr.push(_thisEm.attr('rec_id')+':'+_thisEm.text());
        });
