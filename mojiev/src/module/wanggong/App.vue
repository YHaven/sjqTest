<template>
    <div id="app">
        ...
        <ul class="wh-nav clearfix">
            ...
            <li cat_name="10"><a href="javascript:;">女士精品</a></li>
            <li cat_name="2"><a href="javascript:;">品质男装</a></li>
            <li cat_name="3"><a href="javascript:;">儿童服饰</a></li>
            <li cat_name="4"><a href="javascript:;">服饰</a></li>
        </ul>
